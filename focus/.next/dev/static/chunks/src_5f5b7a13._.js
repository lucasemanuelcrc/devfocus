...
function usePiP({ timeLeft, maxTime, mode, isRunning }) {
    ...
    const togglePiP = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "usePiP.useCallback[togglePiP]": async ()=>{
            ...
            try {
                if (document.pictureInPictureElement) {
                    ...
                    if (video.readyState < 1) {
                        await new Promise({
                            "usePiP.useCallback[togglePiP]": (resolve)=>{
                                video.onloadedmetadata = ({
                                    "usePiP.useCallback[togglePiP]": ()=>resolve(true)
                                })["usePiP.useCallback[togglePiP]"];
                            }
                        }["usePiP.useCallback[togglePiP]"]);
                    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "usePiP.useEffect": ()=>{
            ...
            if (!video) return;
            const onLeave = {
                "usePiP.useEffect.onLeave": ()=>setIsPiPActive(false)
            }["usePiP.useEffect.onLeave"];
            video.addEventListener('leavepictureinpicture', onLeave);
            return ({
                "usePiP.useEffect": ()=>video.removeEventListener('leavepictureinpicture', onLeave)
            })["usePiP.useEffect"];
        }
    }["usePiP.useEffect"], []);
    return {
...
_s(usePiP, "R84HLtPvhfO+1emukpwYfBNVg1M=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
        ...
        "TimerCard.useEffect": ()=>{
            ...
            if (isRunning && timeLeft > 0) {
                interval = setInterval({
                    "TimerCard.useEffect": ()=>{
                        setTimeLeft({
                            "TimerCard.useEffect": (prev)=>prev - 1
                        }["TimerCard.useEffect"]);
                    }
          ...
          `,
              ...
              `,
                                ...
                                children: isCompleted ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                    ...
                                    lineNumber: 399,
                                    columnNumber: 18
                                }, this) : isRunning ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
...
_s(TimerCard, "peTesxX5Vx5HRbXFXfOmLrsjRUs=", false, function() {
    return [
